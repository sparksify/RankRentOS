...
export const METRICS: readonly RegistryEntry[] = [
  ...
  { id: "asset.renter.churned.date", kind: "string", unit: "iso-date", allowedEvidenceTypes: ["OBSERVED"], staleAfterDays: 36500, description: "Renter cancelled/stopped paying. The real objective is boring recurring revenue; churn is its primary falsifier" },
  { id: "asset.renter.complaints", kind: "number", unit: "count", allowedEvidenceTypes: ["OBSERVED"], staleAfterDays: 36500, description: "Lead-quality complaints from the renter for the period — the leading indicator of churn and of the agency-trap failure mode" },
  { id: "asset.renter.retention.months", kind: "number", unit: "months", allowedEvidenceTypes: ["OBSERVED", "DERIVED"], staleAfterDays: 36500, description: "Consecutive months the current renter has paid" },
